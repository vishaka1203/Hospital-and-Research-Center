    ...
    >
      <div className="container">
        ...
        >
          ...
          <h1>Well Woman Clinic</h1>
          <p
            style={{ textAlign: 'left', fontFamily: 'poppins', color: 'white' }}
          >
            Women at all stages of life, from early teens to menopause and
            beyond will experience a variety of hormonal, medical, physical and
            emotional conditions that require attention and care. <br />
            <br />
            Dr. Dukle’s Well Woman Clinic deals specifically with medical issues
            related to women. A one-stop health-care facility focused for women.
            Well Woman Clinic is designed exclusively to provide women with a
            same-day health-care service.
            <br />
            <br />
            ...
            treatment of numerous medical problems of special concern to women.
            As well as, accommodating patients seeking second opinions.
            <br />
            <br />
            ...
            protocols Well Woman Clinic provides medical and surgical solutions
            for a varied gynaecological problems like menstrual abnormalities,
            infertility, prolapsed uterus, fibroids, other tumours of the uterus
            and ovaries and also has well developed protocols for teenage
            menstrual cycle issues, counselling support and interdisciplinary
            cohesive consultation for hormonal issues such as thyroid,
            polycystic ovarian disorders, etc.
            <br />
            <br />
            Well Woman Clinic is dedicated for cervical cancer diagnosis,
            prevention and vaccination. The clinic offers comprehensive medical
            expertise and awareness material to the woman of today to safeguard
            herself from the growing incidences.
            <br />
            <br />
        ...
        <div className="row g-4">
          ...
          <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            <div className="service-item bg-light rounded h-100 p-5">
              ...
              <p className="mb-4">
                Comprehensive care for new mothers and infants after childbirth.
              </p>
              <a className="btn" href="">
                <i className="fa fa-plus text-primary me-3"></i>Read More
              </a>
          ...
          <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
            <div className="service-item bg-light rounded h-100 p-5">
              ...
              <p className="mb-4">
                State-of-the-art surgical solutions enhancing women's health and
                well-being.
              </p>
              <a className="btn" href="">
                <i className="fa fa-plus text-primary me-3"></i>Read More
          ...
          <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
            <div className="service-item bg-light rounded h-100 p-5">
              ...
              <p className="mb-4">
                Diagnostic imaging method using sound waves for precise medical
                evaluation.
              </p>
              <a className="btn" href="">
                <i className="fa fa-plus text-primary me-3"></i>Read More
          ...
          <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
            <div className="service-item bg-light rounded h-100 p-5">
              ...
              <p className="mb-4">
                Comprehensive health assessment tailored for women's well-being.
              </p>
              <a className="btn" href="">
                <i className="fa fa-plus text-primary me-3"></i>Read More
              </a>
          ...
          <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
            <div className="service-item bg-light rounded h-100 p-5">
              ...
              <p className="mb-4">
                Enhancing gynaecological aesthetics and function with precision
                procedures.
              </p>
              <a className="btn" href="">
                <i className="fa fa-plus text-primary me-3"></i>Read More
