...
const Diagnostics = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: `linear-gradient( rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(${diagnosis})`,
      }}
    >
      <div class="container">
        <div
        ...
        <div class="row g-4">
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            <div class="service-item bg-light rounded h-100 p-5">
              ...
              <p class="mb-4">
                Unlock your heart's health: Discover our Stress Test service for
                cardiac wellness.
              </p>
              <a class="btn" href="">
                <i class="fa fa-plus text-primary me-3"></i>Read More
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
            <div class="service-item bg-light rounded h-100 p-5">
              ...
              <p class="mb-4">
                Breathe easy with our Spirometry service: Precision testing for
                respiratory health.
              </p>
              <a class="btn" href="">
                <i class="fa fa-plus text-primary me-3"></i>Read More
