...
const IntPatients = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: `linear-gradient( rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url(${IntP})`,
      }}
    >
      <div className="container">
        ...
        >
          ...
          <h3 className="h3">
            DHRC is proud to have been of service to patients from more than 50
            countries.
          </h3>
          ...
          >
            ...
            international patients on all counts, be it quality of healthcare or
            other support services such as travel and stay. Dr. Dukle’s Hospital
            renders superlative services in the lines of International Patient
            Care, and has therefore carved a niche in the Medical Tourism
            sector.
            <br />
          </p>
        </div>
